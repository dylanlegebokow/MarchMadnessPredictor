# Gets the data for 2019 Teams for predictions
...
vector_length = 26
out_file = 'data\PredictionData\data_2019.csv'
...
if __name__ == '__main__':
    ...
    with open('data\PredictionData\MMSeeds_with_Team_IDs.csv') as f:
        lines = f.readlines()
        for line in lines:
            ...
            mm_stats = 'data\PredictionData\TeamStats_2019.csv'
            rating_stats = 'data\PredictionData\RatingStats_2019.csv'
            conference_stats = 'data\PredictionData\Conference_2019.csv'
            ...
            with open(mm_stats) as a:
                ...
                for bx in bxs:
                    ...
                    if school_name1 == team_name:
                        ...
                        fgm = per_game(games_played, int(fgm.strip().strip('"')))
                        ...
                        data_point = assign_1(data_point, games_played, wins, fgm, fgp, threem, threep, ftm,
                                              ftp, otb, trb, ast, stl, blk, tov, pf)
